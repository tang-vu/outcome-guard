...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="siteFooter"><span>OutcomeGuard · Shannon testnet prototype · not financial advice</span><span><a href="https://youtu.be/0Z_CaNJD1Uw" target="_blank" rel="noreferrer">Watch the 2:35 demo ↗</a> · Event Contracts are nonlinear protection, not a perfect hedge.</span></footer>
  </main>;
}
