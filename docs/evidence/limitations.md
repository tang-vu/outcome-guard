...
- Real transaction hashes, fills, reconciled positions, losing and winning settlements, a successful redemption, deployment URL, and checksum-recorded demo video are present. No private key or human-wallet execution is claimed.
